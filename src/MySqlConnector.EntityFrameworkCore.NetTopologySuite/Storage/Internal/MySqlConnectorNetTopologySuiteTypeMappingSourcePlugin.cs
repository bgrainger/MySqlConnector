...
namespace MySqlConnector.EntityFrameworkCore.MySql.Storage.Internal
{
	...
	/// </summary>
	public class MySqlConnectorNetTopologySuiteTypeMappingSourcePlugin : IRelationalTypeMappingSourcePlugin
	{
		...
		///     directly from your code. This API may change or be removed in future releases.
		/// </summary>
		public MySqlConnectorNetTopologySuiteTypeMappingSourcePlugin(IGeometryServices geometryServices)
		{
			if (geometryServices is null)
				throw new ArgumentNullException(nameof(geometryServices));
		...
		public virtual RelationalTypeMapping FindMapping(in RelationalTypeMappingInfo mappingInfo)
		{
			...
			return (clrType != null
				...
				? (RelationalTypeMapping)Activator.CreateInstance(
					typeof(MySqlConnectorGeometryTypeMapping<>).MakeGenericType(clrType ?? defaultClrType ?? typeof(IGeometry)),
					_geometryServices,
